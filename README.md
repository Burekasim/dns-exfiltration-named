This script was used at the AWS IL Community day during a demo.__

This script listens to named (BIND) server (DNS) queries,__
Make sure you have the following setting in your /etc/bind.conf: __
...
You will need the following:__
...
How does it work?__
Once everything is configured, the script monitors the BIND query log, if there is a query in the following format: __
...
My setup was:__
avi.co.il hosted on Route53__
b.avi.co.il and a.avi.co.il are delegated DNS yoyo.yeah.co.il. (one of the domains that I own)__
yoyo.yeah.co.il A record leads to an EC2 instance with an Elastic IP.__
